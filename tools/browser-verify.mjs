...
//
// Runs the explorer's in-browser verifier against a real evidence
// bundle, outside a browser.
//
// The explorer claims a reader can check a proof for themselves, in the
// page, without trusting the register. That claim is only worth
...
console.log('\nthe page agrees with the register: genuine verifies, edited does not.');
